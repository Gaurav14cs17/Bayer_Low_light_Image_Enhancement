...
class load_data_SID(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_short_crop = np.clip(img_short_crop.astype(np.float32), 512, 16383)  # Hard clip
        img_short_crop = (img_short_crop - 512) / (16383 - 512 + 1e-6) * ap  # Add epsilon
        img_long_crop = np.clip(img_long_crop, 0, 65535) / 65535.0		
